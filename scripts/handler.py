...
def is_allowed_mime_type(filename):
    """Verifica si el tipo MIME del archivo es válido."""
...
def check_disk_space(file_size, upload_dir):
    """Verifica si hay suficiente espacio en disco antes de subir un archivo."""
...
class CustomHTTPRequestHandler(SimpleHTTPRequestHandler):
    ...
    def handle_shopping_list_get(self):
        """Maneja la solicitud GET para obtener la lista de compras."""
        self.send_response(200)
    ...
    def handle_add_item_post(self):
        """Maneja la solicitud POST para agregar un ítem a la lista de compras."""
        content_length = int(self.headers.get('Content-Length', 0))
    ...
    def handle_remove_item_delete(self):
        """Maneja la solicitud DELETE para eliminar un ítem de la lista de compras."""
    ...
    def handle_calendar_get(self):
        """Maneja la solicitud GET para obtener los eventos del calendario por mes y año."""
        # Parsear los parámetros de la URL
        parsed_url = urllib.parse.urlparse(self.path)
        query_params = urllib.parse.parse_qs(parsed_url.query)
        
        # Obtener los parámetros de mes y año
        try:
        ...
        # Responder con un error si no se proporcionaron correctamente
    ...
    def handle_add_event_post(self):
        """Maneja la solicitud POST para agregar un evento al calendario."""
        content_length = int(self.headers.get('Content-Length', 0))
        post_data = self.rfile.read(content_length).decode()
    ...
    def handle_delete_event(self):
        ...
        # Remove the event that matches both date and title
